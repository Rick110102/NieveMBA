 ...
 * 
 */ 
// Endmembers: Es un diccionario que contiene valores espectrales  para diferentes sensores
// de satelites Landsat y Sentinel. Los endmembers finales representan firmas espectrales
// puras para diferentes tipos de cobertura terrestre
      // Vegetacion verde (GV)
...
/* ndfiColors: Cadena de codigos hexadecimales, probablemente utilizada para mapeo de colores
o visualziacion de indices*/
...
Funciones princpales:
    getFractions(): Desmonta una imagen en fracciones de diferentes tipos 
                    de cobertura terrestre
    getNDFI(): Índice de Fracción de Diferencia Normalizada
    getSEFI(): Índice de Fracción de Miembro Espectral
    getWEFI(): Índice de Fracción de Miembro Espectral Ponderado
    getFNS(): Fracción de Sombra Normalizada
 */
