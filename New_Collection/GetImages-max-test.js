...
var mos = require('users/mapbiomasaguaperu/GlaciaresWet2026:New_Collection/MosaicMax.js');
...
Ajusta los valores de bandas opticas y termicas, así como normaliza la reflectancia
De las imagenes.
 */
...
/*
Funcion principal getImages() que gestiona toda la coleccion de imágenes
Permite configurar parametros como:
    * Rango de fechas
    * Satelite
    * Cobertura de nubes
    * Region mosaico 
    * Lista negra de imágenes
*/
