...
// Funcion getMosaic()
// Crea mosaico de imágenes con diferentes estadisticas
// Caracteristicas principales
  // Divide la colección en temporadas seca y húmeda
  // Calcula diferentes mosaicos:
      // Mediana general
      // Mediana temporada seca
      // Mediana temporada húmeda
      // Mínimo
      // Máximo
      // Amplitud
      // Desviación estándar
...
// Usa percentiles para definir temporadas
// Agrupa imágenes segun indice NDSI
// Reduce colección con diferentes reductores
    ...
    var collectionDry = obj.collection.map(
        function (image) {
            return image.mask(image.select(['ndsi']).lte(ndviDry));
        }
    );
    ...
    var mosaicWet = collectionWet.reduce(ee.Reducer.max())
        .rename(bandsWet);
