...
// Creacion de colecciones de imágenes satelitales
// Funcion setProperties
// Busca normalizar las propiedades de imágenes de diferentes satelites
// Propiedades normalizadas
  // cloudCover: Porcentaje de cobertura de nubes
      // Busca en diferentes metadatos: 'CLOUDY_PIXEL_PERCENTAGE', 'CLOUD_COVER'
  
  // date: Fecha de adquisición de la imagen
      // Busca en: 'DATE_ACQUIRED', 'SENSING_TIME', 'GENERATION_TIME'
  
  // satellite: Nombre del satélite
      // Busca en: 'SPACECRAFT_ID', 'SATELLITE', 'SPACECRAFT_NAME'
  
    // azimuth: Ángulo azimutal solar
      // Busca en: 'SUN_AZIMUTH', 'SOLAR_AZIMUTH_ANGLE', 'MEAN_SOLAR_AZIMUTH_ANGLE'
  
  // elevation: Ángulo de elevación solar
      // Convierte ángulo cenital a elevación si es necesario
      // Busca en: 'SUN_ELEVATION', 'SOLAR_ZENITH_ANGLE', 'MEAN_SOLAR_ZENITH_ANGLE'
...
var setProperties = function (image) {
    ...
    var reflectance = ee.Algorithms.If(
        ee.String(ee.Dictionary(ee.Algorithms.Describe(image)).get('id')).match('TOA').length(),
        'TOA',
        'SR'
    );
    
// Nuevas Propiedades Establecidas:
    // image_id: ID de la imagen
    // cloud_cover: Porcentaje de nubes
    // satellite_name: Nombre del satélite
    // sun_azimuth_angle: Ángulo azimutal
    // sun_elevation_angle: Ángulo de elevación
    // reflectance: Tipo de reflectancia
...
// Crea una coleccion de imágenes con filtros específicos
        // collectionid: ID de la colección satelital
        // geometry: Área geográfica de interés
        // dateStart: Fecha de inicio
        // dateEnd: Fecha de fin
        // cloudCover: Límite de cobertura de nubes
