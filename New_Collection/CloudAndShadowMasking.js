 ...
 */
//********************************************************************************
//***************************** DESCRIPCION DE LA FUNCION RESCALE******************
//********************************************************************************
// Funcion rescale()
// Reesacala una imagen a un rango normalizado

var rescale = function (obj) {
    // Recibe un objeto con imagen, con valor minimo y maximo
    // Transforma los valores de la imagen a un rango entre 0 y 1
    var image = obj.image.subtract(obj.min).divide(ee.Number(obj.max).subtract(obj.min));

    return image;
};
    // Util para perparar imágenes para analisis comparativos
 ...
 */
//********************************************************************************
//*************** DESCRIPCION DE LA FUNCION CLOUDSCORE ***************************
//********************************************************************************
// Genera una máscara de nubes usando múltiples indicadores 
// Evalua la presencia de nubes en diferentes bandas
     // Banda azul, Bnadas visibles, Bandas infrarrojas y bandas de temperatura
// Calcula un puntaje de nubosidad, usando un umbral de 75 para identificar nubes
// Genera una banda de máscara de nubes llamada 'cloudScoreMask' 
...
//********************************************************************************
//*************** DESCRIPCION DE LA FUNCION TDOM ***********************
//**************** Temporal Dark Object Mask ***************************
//********************************************************************************
// Metodo para detectar sombras de nubes
// Computa estadísticas de bandas NIR y SWIR1 en una colección de imágenes
// Calcula z-scores para identificar pixeles osucros anómalos
// Identifica sombras basandose en 
      // Z-score menor a un umbral
      // Valor de suma de bandas oscuras
// Agraga una banda 'tdomMask' a cada imagen
...
//********************************************************************************
//*************** DESCRIPCION DE LA FUNCION CLOUDPROJECT ***********************
//**************** Temporal Dark Object Mask ***********************************
//********************************************************************************
// Proyecta sombras de nubes considerando geometría solar
// Calcula la posición potencial de sombras basándose en:
          // Altura de nubes, angulo azimutal solar, angulo de elevación solar
// Genera una máscara de sombras llamada 'shadowTdomMask'
...
// Funciones de Máscara BQA:
// cloudBQAMaskSr(): Genera máscara de nubes usando bits de calidad
// cloudBQAMask(): Agrega máscara de nubes a la imagen
// shadowBQAMaskSrLX(): Genera máscara de sombras usando bits de calidad
// shadowBQAMask(): Agrega máscara de sombras a la imagen
...
var cloudBQAMaskSr = function (image) {
    ...
    // var cloudMask = qaBand.bitwiseAnd(Math.pow(2, 1))
    //                       .and(qaBand.bitwiseAnd(Math.pow(2, 2)))
    //                       .and(qaBand.bitwiseAnd(Math.pow(2, 3)))
    //                       .neq(0)
    //                       .rename('cloudBQAMask');
...
// Función principal para aplicar máscaras de nubes y sombras
// Permite configurar múltiples métodos de enmascaramiento:
      // Máscara de nubes BQA
      // Puntaje de nubes
      // Máscara de sombras BQA
      // Máscara de sombras TDOM

// Configurable con múltiples parámetros
// Retorna una colección de imágenes con máscaras adicionales
