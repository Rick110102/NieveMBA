 ...
 * 
 */
// Asignacion de bandas y descripcion de las mismas, satelites L4, L5, L7 Y L8
// Contenido del objeto:
          //bandNames: Nombres originales de las bandas en el archivo de la imagen
          //newNames: Nombres estandarizados y más descriptivos de las bandas
var bandNames = {
 ...
 */
 ...
 // Funcion de exportacion get()
 // Permite obtener la configuración de bandas para un sensor específico
 // Pasando su clave
 // Para usar: bandNames.get('clave_del_satelite')
